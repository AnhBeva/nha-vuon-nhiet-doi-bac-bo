# Module 32: Cấp thoát nước, bể, bơm và vệ sinh

**Tổ chức nước sạch, nước mưa, nước thải, thoát sàn và điểm kiểm tra.**
...
**Một câu cần nhớ:** Tổ chức nước sạch, nước mưa, nước thải, thoát sàn và điểm kiểm tra.

**Mục tiêu năng lực sau bài này:**

- Gọi đúng tên vấn đề liên quan đến cấp thoát nước, bể, bơm và vệ sinh.
...
**Bản chất:** Cấp thoát nước, bể, bơm và vệ sinh là một phần của hệ nhà - vườn - khí hậu - con người - kỹ thuật. Nó không nên được xử lý như một hạng mục cô lập.
...
| Quyết định phải đưa ra | Có khóa phương án liên quan đến cấp thoát nước, bể, bơm và vệ sinh ngay bây giờ hay cần thêm kiểm chứng? |
...
|---|---|---|
| Có ảnh, số đo hoặc quan sát thực tế liên quan đến cấp thoát nước, bể, bơm và vệ sinh |  |  |
...
Sau module này, bạn nên tạo được một trang ghi chú dự án gồm: vấn đề liên quan đến **Cấp thoát nước, bể, bơm và vệ sinh**, dữ kiện đã có, câu hỏi cần hỏi, phương án đang cân nhắc, rủi ro chính, tiêu chí nghiệm thu và hành động tiếp theo.
