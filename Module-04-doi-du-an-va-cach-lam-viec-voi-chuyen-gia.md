# Module 04: Đội dự án và cách làm việc với chuyên gia

**Phân vai kiến trúc sư, kỹ sư, cảnh quan, nhà thầu và chủ nhà để giảm hiểu nhầm.**
...
**Một câu cần nhớ:** Phân vai kiến trúc sư, kỹ sư, cảnh quan, nhà thầu và chủ nhà để giảm hiểu nhầm.

**Mục tiêu năng lực sau bài này:**

- Gọi đúng tên vấn đề liên quan đến đội dự án và cách làm việc với chuyên gia.
...
**Bản chất:** Đội dự án và cách làm việc với chuyên gia là một phần của hệ nhà - vườn - khí hậu - con người - kỹ thuật. Nó không nên được xử lý như một hạng mục cô lập.
...
| Quyết định phải đưa ra | Có khóa phương án liên quan đến đội dự án và cách làm việc với chuyên gia ngay bây giờ hay cần thêm kiểm chứng? |
...
|---|---|---|
| Có ảnh, số đo hoặc quan sát thực tế liên quan đến đội dự án và cách làm việc với chuyên gia |  |  |
...
Sau module này, bạn nên tạo được một trang ghi chú dự án gồm: vấn đề liên quan đến **Đội dự án và cách làm việc với chuyên gia**, dữ kiện đã có, câu hỏi cần hỏi, phương án đang cân nhắc, rủi ro chính, tiêu chí nghiệm thu và hành động tiếp theo.
